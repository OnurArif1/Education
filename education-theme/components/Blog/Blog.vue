...
<!--    </hidden>-->
    <v-container class="fixed-width">
      <div class="pa-md-8 pa-2">
        <v-row>
          <v-col>
            <h1 style="font-size: 50px">{{ $t('educationLanding.contactUs_title') }}</h1>
          </v-col>
        </v-row>
        <v-row>
          <v-col>
            <p style="font-size: 25px">
              {{ $t('educationLanding.contactUs_address') }}
            </p>
            <p style="font-size: 25px">
              {{ $t('educationLanding.contactUs_phone') }}
            </p>
            <p style="font-size: 25px">
              Email: info@newbridgeedu.co.uk
            </p>
          </v-col>
        </v-row>
<!--        <title-main-->
