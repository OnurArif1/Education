      ...
      <div class="header-content">
        ...
        >
          ...
          <div class="logo">
            <nuxt-link
              v-if="invert"
              :to="localePath(link.education.home)"
            >
              <img
                :src="logo"
                alt="logo"
          ...
          <div v-if="isDesktop">
            <ul class="scrollactive-nav">
              ...
              >
                ...
                >
                  <span v-if="index === 0" class="text">
                    {{ $t('educationLanding.header_home') }}
                  </span>
                  <span v-else-if="index === 1" class="text">
                    {{ $t('educationLanding.services') }}
                  </span>
                  <span v-else-if="index === 2" class="text">
...
<!--              <li>-->
<!--                <v-btn-->
<!--                  :to="localePath(link.education.contact)"-->
<!--                  variant="text"-->
<!--                >-->
<!--                  <span class="text">-->
<!--                    {{ $t('educationLanding.header_contact') }}-->
